...
> Deploying, versioning, and maintaining ML/AI systems.

---

## Purpose

This module covers **MLOps**. Deploying, versioning, and maintaining ML/AI systems. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
