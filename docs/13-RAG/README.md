...
This module covers **RAG**. Grounding LLMs with retrieval-augmented generation. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
