...
[⬅ 02 · Computer Science](../02-Computer-Science/README.md) · [🏠 docs](../README.md) · [🗺 Roadmap](../../ROADMAP.md) · [04 · Git ➡](../04-Git/README.md)
...
This module covers **Linux**. The command line and operating-system foundations AI systems run on. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
...
| ⬅ Previous | [⬅ 02 · Computer Science](../02-Computer-Science/README.md) |
| ➡ Next | [04 · Git ➡](../04-Git/README.md) |
