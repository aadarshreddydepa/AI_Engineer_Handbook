...
[⬅ 17 · Cloud](../17-Cloud/README.md) · [🏠 docs](../README.md) · [🗺 Roadmap](../../ROADMAP.md) · [19 · Production AI ➡](../19-Production-AI/README.md)

> Designing scalable, reliable systems — including AI systems.

---

## Purpose

This module covers **System Design**. Designing scalable, reliable systems — including AI systems. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
...
| ⬅ Previous | [⬅ 17 · Cloud](../17-Cloud/README.md) |
| ➡ Next | [19 · Production AI ➡](../19-Production-AI/README.md) |
