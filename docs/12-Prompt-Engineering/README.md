...
> Reliably steering LLMs through structured prompting and reasoning techniques.

---

## Purpose

This module covers **Prompt Engineering**. Reliably steering LLMs through structured prompting and reasoning techniques. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
