...
> Adapting foundation models with parameter-efficient fine-tuning and alignment.

---

## Purpose

This module covers **Fine Tuning**. Adapting foundation models with parameter-efficient fine-tuning and alignment. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
