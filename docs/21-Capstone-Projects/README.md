...
[⬅ 20 · Interview Preparation](../20-Interview-Preparation/README.md) · [🏠 docs](../README.md) · [🗺 Roadmap](../../ROADMAP.md) · [Roadmap ➡](../../ROADMAP.md)

> End-to-end production systems that prove your capability.

---

## Purpose

This module covers **Capstone Projects**. End-to-end production systems that prove your capability. It fits into the overall program as described in the [Roadmap](../../ROADMAP.md) and [Curriculum](../../CURRICULUM.md).
...
- [AI Agents](../14-AI-Agents/README.md)
- [Production AI](../19-Production-AI/README.md)
...
| ⬅ Previous | [⬅ 20 · Interview Preparation](../20-Interview-Preparation/README.md) |
